...
2. **Graphics Driver**
   ...
   - GeForce Experience and NVIDIA Control Panel installed to support future driver/display updates.

3. **Network Drivers**
   - Ethernet and Wi-Fi drivers installed and validated for connectivity and stability
...
This baseline supports future troubleshooting, benchmarking, and change tracking.
